...
local jbinding = require("jbinding")
local ut = require("Test.More")
local cjson = require("cjson")

local bind   = jbinding.bind
local NUMBER = jbinding.NUMBER
local STRING = jbinding.STRING
local ARRAY  = jbinding.ARRAY
local OBJECT = jbinding.OBJECT
local STRINGIFY_ARRAY  = jbinding.STRINGIFY_ARRAY
local STRINGIFY_OBJECT = jbinding.STRINGIFY_OBJECT
